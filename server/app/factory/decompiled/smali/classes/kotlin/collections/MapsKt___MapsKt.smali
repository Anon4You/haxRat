...
.method public constructor <init>()V
    ...
    invoke-direct {v1}, Lkotlin/collections/MapsKt__MapsKt;-><init>()V
...
.method public static final flatMap(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    .param p0    # Ljava/util/Map<? extends K;? extends V;>;
        ...
        .end annotation
    .end param
    .param p1    # Lkotlin/jvm/functions/Function1<? super Ljava/util/Map$Entry<? extends K;? extends V;>;? extends Ljava/lang/Iterable<? extends R;>;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public static final flatMapTo(Ljava/util/Map;Ljava/util/Collection;Lkotlin/jvm/functions/Function1;)Ljava/util/Collection;
    ...
    .param p1    # Ljava/util/Collection;
        ...
        .end annotation
    .end param
    .param p2    # Lkotlin/jvm/functions/Function1<? super Ljava/util/Map$Entry<? extends K;? extends V;>;? extends Ljava/lang/Iterable<? extends R;>;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public static final forEach(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)V
    ...
    .param p0    # Ljava/util/Map<? extends K;? extends V;>;
        ...
        .end annotation
    .end param
    .param p1    # Lkotlin/jvm/functions/Function1<? super Ljava/util/Map$Entry<? extends K;? extends V;>;Lkotlin/Unit;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public static final mapNotNull(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/List;
    ...
    invoke-interface/range {v16 .. v17}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z
...
.method private static final maxWith(Ljava/util/Map;Ljava/util/Comparator;)Ljava/util/Map$Entry;
    ...
    invoke-static {v3, v4}, Lkotlin/collections/CollectionsKt;->maxWith(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/lang/Object;
...
.method public static final minWith(Ljava/util/Map;Ljava/util/Comparator;)Ljava/util/Map$Entry;
    ...
    .param p0    # Ljava/util/Map<? extends K;? extends V;>;
        ...
        .end annotation
    .end param
    .param p1    # Ljava/util/Comparator<? super Ljava/util/Map$Entry<? extends K;? extends V;>;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    invoke-static {v2, v3}, Lkotlin/collections/CollectionsKt;->minWith(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/lang/Object;
