...
.method public constructor <init>()V
    ...
    invoke-direct {v1}, Lkotlin/collections/MapsKt__MapWithDefaultKt;-><init>()V
...
.method public static final getOrPut(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    .locals 11
    .param p0    # Ljava/util/concurrent/ConcurrentMap<K;V;>;
...
.method private static final toProperties(Ljava/util/Map;)Ljava/util/Properties;
    .locals 8
    .param p0    # Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    invoke-virtual {v5, v6}, Ljava/util/Properties;->putAll(Ljava/util/Map;)V
...
.method public static final toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    const-string v6, "java.util.Collections.singletonMap(key, value)"
    ...
    const-string v6, "with(entries.iterator().\u2026ingletonMap(key, value) }"
...
.method public static final toSortedMap(Ljava/util/Map;Ljava/util/Comparator;)Ljava/util/SortedMap;
    ...
    .param p0    # Ljava/util/Map<? extends K;? extends V;>;
        ...
        .end annotation
    .end param
    .param p1    # Ljava/util/Comparator<? super K;>;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
